...
import { IoIosAddCircle, IoIosSkipBackward } from "react-icons/io"
...
function MenuHijos({ handleCloseHijos, id_padre }) {
    ...
    const Agregar_handled = () => {
        ...
        formik.values.id_padre = id_padre
        setShow(true)
    }
  ...
  return (
        <>
            ...
            <div className="gap-2">
                <div>
                    <Button size="sm" variant="outline-primary" onClick={Agregar_handled}>
                        <IoIosAddCircle />
                        {` Agregar`}
                    </Button>
                    <Button className="mx-2 my-2" size="sm" variant="outline-primary" onClick={Refrescar_handled}>
                        <TbRefresh />
                        {` Refrescar`}
                    </Button>
                    <Button size="sm" variant="outline-primary" onClick={handleCloseHijos}>
                        <IoIosSkipBackward />
                        {` Cerrar `}
                    </Button>
                </div>
                        ...
                        {data.map(row => (
                            <tr key={row.id_cajero}>
                                ...
                                <td className="align-content-center justify-content-center text-center">
                                    <Button size="sm" variant="danger" onClick={() => edit_handled(row)}>
                                        <CiEdit />
                                    </Button>
                                </td>
                            </tr>
