...
INSERT INTO `agenda` VALUES (1,2,'2025-02-21','17:00:00','17:30:00',1,1,2),(1,3,'2025-02-21','15:00:00','15:30:00',1,1,3);
...
BEGIN
	...
	FROM intervalos_tiempo I
	LEFT JOIN agenda A ON A.id_empresa = prm_id_empresa AND A.fecha = prm_fecha AND A.hora_inicio = I.hora_inicio AND A.hora_fin = I.hora_fin
    LEFT JOIN agenda_estatus AE ON AE.id_agenda_estatus = A.id_agenda_estatus
...
-- Dump completed on 2025-02-21 18:00:57
