...
INSERT INTO `agenda` VALUES (1,8,'2025-03-06','11:30:00','12:00:00',1,NULL,3,4,'BUGKF7'),(1,7,'2025-03-04','16:00:00','16:30:00',1,NULL,2,2,'O0ZQW6'),(1,6,'2025-03-04','13:30:00','14:00:00',1,NULL,2,2,'GOWXSK'),(1,5,'2025-03-04','13:00:00','13:30:00',1,NULL,2,2,'DITWWA'),(1,4,'2025-03-04','12:30:00','13:00:00',1,NULL,2,2,'W9VCFA'),(1,3,'2025-03-04','12:00:00','12:30:00',1,NULL,2,2,'1NUCDW'),(1,2,'2025-03-04','11:30:00','12:00:00',1,NULL,2,2,'KOVVI3'),(1,1,'2025-03-04','11:00:00','11:30:00',1,NULL,2,2,'CGNUDJ'),(1,9,'2025-03-06','14:00:00','14:30:00',1,NULL,3,4,'CGZNFS'),(1,10,'2025-03-06','15:00:00','15:30:00',1,NULL,2,4,'IHTXGK'),(1,11,'2025-03-06','16:30:00','17:00:00',0,NULL,2,4,'WQLSGU'),(1,12,'2025-03-04','16:30:00','17:00:00',5,NULL,2,2,'WVWB86'),(1,13,'2025-03-15','15:00:00','15:30:00',6,NULL,4,6,'9PAJUL');
...
CREATE TABLE `clientes` (
  ...
  `empresa` varchar(200) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `nombre` varchar(200) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL,
  `telefonos` varchar(90) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `celulares` varchar(90) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL,
  `fecha_ultima_visita` datetime DEFAULT NULL,
  `fecha_ultima_compra` datetime DEFAULT NULL,
  PRIMARY KEY (`id_empresa`,`id_cliente`),
  KEY `idx_empresa_celular` (`id_empresa`,`celulares`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `landingPage` (
  ...
  `mostrar_landingPage` tinyint DEFAULT NULL,
...
CREATE TABLE `procMenu` (
  `id_empresa` int NOT NULL,
  `id_procMenu` int NOT NULL AUTO_INCREMENT,
  `id_padre` int DEFAULT NULL,
  `nombre` varchar(255) COLLATE latin1_spanish_ci NOT NULL,
  `orden` int DEFAULT NULL,
  `activo` tinyint(1) DEFAULT NULL,
  `linkTo` varchar(255) COLLATE latin1_spanish_ci DEFAULT NULL,
  `icono` varchar(255) COLLATE latin1_spanish_ci DEFAULT NULL,
...
INSERT INTO `procMenu` VALUES (1,1,0,'Inicio',0,10,'',''),(1,2,0,'Landing Page',20,1,'',''),(1,3,0,'Ventas',30,1,'',''),(1,4,0,'Compras',40,1,'',''),(1,5,0,'Cartera',50,1,'',''),(1,6,0,'Inventario',60,1,'',''),(1,7,0,'Caja',70,1,'',''),(1,8,0,'Facturación',80,1,'',''),(1,9,0,'Admin',90,1,'',''),(1,10,0,'Mesa de Ayuda',100,1,'',''),(1,11,0,'Notificaciones',110,1,'',''),(1,12,0,'Usuario',120,1,'',''),(1,13,0,'Admin',130,1,'',''),(1,14,2,'¿Quienes somos?',10,1,'',''),(1,15,2,'Productos',20,1,'',''),(1,16,2,'Servicio',30,1,'',''),(1,17,2,'Contáctanos',40,1,'',''),(1,18,3,'Pedido / Cotizar',10,1,'',''),(1,19,4,'ABC Proveedores',10,1,'',''),(1,20,4,'Orden de Compra',20,0,'',''),(1,21,4,'Punto de reorden',30,0,'',''),(1,22,5,'ABC Clientes',10,1,'',''),(1,23,5,'Agenda',20,1,'',''),(1,24,5,'Estado de cuente',30,0,'',''),(1,25,5,'Antiguedad de Saldos',40,0,'',''),(1,26,6,'ABC Productos',10,1,'',''),(1,27,6,'ABC Categorias',20,1,'',''),(1,28,6,'Pedido Canvas',30,1,'',''),(1,29,6,'Kardex',40,0,'',''),(1,30,6,'Recepción de Mercancía',50,0,'',''),(1,31,6,'Devoluciones',60,0,'',''),(1,32,6,'Entrega de Mercancía',70,0,'',''),(1,33,7,'Recepcion de Pagos',10,0,'',''),(1,34,7,'Generación de Remisión',20,0,'',''),(1,35,7,'Generación de Factura',20,0,'',''),(1,36,8,'Consulta de Facturas',10,0,'',''),(1,37,8,'Consulta de Comprobantes',20,0,'',''),(1,38,12,'Entrar',10,1,'',''),(1,39,12,'Salir',20,1,'',''),(1,40,12,'Perfil',30,1,'',''),(1,41,9,'Conf. Menú',10,1,'',''),(1,42,41,'Menú dinámico',10,1,'',''),(1,43,42,'Roles',20,1,'',''),(1,44,42,'Rol - Menú',30,1,'',''),(1,45,41,'Usuario - Rol',40,1,'',''),(1,46,9,'Conf. CRM',10,1,'',''),(1,47,46,'Usuarios',10,1,'',''),(1,48,46,'Productos',20,1,'',''),(1,49,46,'Landing Page',30,1,'','');
...
CREATE TABLE `rol_menu` (
  `id_empresa` int NOT NULL,
  `id_rol` int NOT NULL,
  `id_procMenu` int NOT NULL,
  PRIMARY KEY (`id_empresa`,`id_rol`,`id_procMenu`),
  KEY `ix_roles` (`id_empresa`,`id_rol`),
  KEY `ix_procMenu` (`id_empresa`,`id_procMenu`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `rol_menu` VALUES (1,1,1),(1,1,2),(1,1,3),(1,1,4),(1,1,5),(1,1,6),(1,1,7),(1,1,8),(1,1,9),(1,1,10),(1,1,11),(1,1,12),(1,1,13),(1,1,14),(1,1,15),(1,1,16),(1,1,17),(1,1,18),(1,1,19),(1,1,20),(1,1,21),(1,1,22),(1,1,23),(1,1,24),(1,1,25),(1,1,26),(1,1,27),(1,1,28),(1,1,29),(1,1,30),(1,1,31),(1,1,32),(1,1,33),(1,1,34),(1,1,35),(1,1,36),(1,1,37),(1,1,38),(1,1,39),(1,1,40),(1,1,41),(1,1,42),(1,1,43),(1,1,44),(1,1,45),(1,1,46),(1,1,47),(1,1,48),(1,1,49);
...
INSERT INTO `roles` VALUES (1,1,'master','2023-12-10 00:00:00','2023-12-10 00:00:00'),(1,2,'admin','2023-12-10 00:00:00','2023-12-10 00:00:00'),(1,3,'Landing Page','2025-03-17 00:00:00','2025-03-17 00:00:00'),(1,4,'Agenda','2025-03-17 00:00:00','2025-03-17 00:00:00');
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`appusercrmadmin`@`%` PROCEDURE `getMenuUsuario`(
    IN p_id_empresa INT,
    IN p_id_usuario INT
)
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`appusercrmadmin`@`%` PROCEDURE `putAgendaCambiaEstatus`(
	IN prm_id_empresa INT,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`appusercrmadmin`@`%` PROCEDURE `putAgendaConfirmar`(
	IN prm_id_empresa INT,
    IN prm_id_agenda INT
)
BEGIN
...
-- Dump completed on 2025-03-18  7:58:24
