...
INSERT INTO `agenda` VALUES (1,2,'2025-02-21','17:00:00','17:30:00',NULL,1,1,2,NULL),(1,3,'2025-02-21','15:00:00','15:30:00',NULL,1,1,3,NULL),(1,4,'2025-02-28','12:00:00','12:30:00',NULL,1,1,4,NULL);
...
BEGIN
	...
	-- Mostrar los registros de la tabla temporal
	SELECT 	I.*, C.nombre AS Nombre, IFNULL(C.celulares, '') AS Celular, IFNULL(AE.descripcion, '') AS Estatus,
...
BEGIN
    ...
    IF NOT EXISTS(
		...
		INSERT INTO agenda (id_empresa, fecha, hora_inicio, hora_fin, id_cliente, id_agenda_estatus, id_jornada, clave_confirmacion) 
			VALUES (prm_id_empresa, CURDATE(), _hora_inicio, _hora_fin, prm_id_cliente, _id_agenda_estatus, _id_jornada, _id_clave_confirmacion);
...
-- Dump completed on 2025-03-04  7:25:47
